...
for (let i = 0; i < picArray.length; i++) {
  ...
  //luodaan h2-elementti ja laitetaan se article elementin sisään
  const h2Elem = document.createElement('h2');
  h2Elem.innerText = picArray[i].title;
  articleElem.appendChild(h2Elem); //lisätään h2Elem articleElem sisään
  // luodaan figure-elementti ja sen lapielementit
  ...
  // lisätään asken luodut elementit figure-elementin sisään
  ...
  pElem.innerText = picArray[0].description;
  articleElem.appendChild(pElem);
  // lisätään luotu article-elementti html-sivulle
